...
<div class="page page--main" data-page="tabs">
	...
	<div class="page__content page__content--with-header">
		...
		<h2 class="page__title">Tables &amp; Toggles</h2>
		
		<p class="welcome">
		Show, hide and toggle different content section using the tabs and toggles designs.
		</p>
		
		<h3>Simple 2 Tabs</h3>
		<div class="tabs tabs--style1 mb-20">
			<input type="radio" name="tabs2" class="tabs__radio" id="tab1" checked="checked">
			<label class="tabs__label tabs__label--12" for="tab1">Tab 01</label>	
			...
			<label class="tabs__label tabs__label--12" for="tab2">Tab 02</label>
			<div class="tabs__content">
		...
		<div class="tabs  tabs--style1 mb-20">
			...
			<label class="tabs__label tabs__label--13" for="tab3">Tab 01</label>	
			<div class="tabs__content">
				<h4>Tab one content</h4>
				<p>
				Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt.
			...
			<label class="tabs__label tabs__label--13" for="tab4">Tab 02</label>
			<div class="tabs__content">
				<h4>Tab two content</h4>
				<p>
				Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt.
			...
			<label class="tabs__label tabs__label--13" for="tab5">Tab 03</label>
			<div class="tabs__content">
		...
		<div class="toggle mb-20">
			<div class="toggle__item">
			  ...
			  <label class="toggle__label" for="togg1">Toggle Title 01 <span></span></label>
			...
			<div class="toggle__item">
			  ...
			  <label class="toggle__label" for="togg2">Toggle Title 02 <span></span></label>
				  <div class="toggle__content">
			...
			<div class="toggle__item">
			  ...
			  <label class="toggle__label" for="togg3">Toggle Title 03 <span></span></label>
				  <div class="toggle__content">
		...
		<div class="accordion mb-20">
			<div class="accordion__item">
			  ...
			  <label class="accordion__label" for="acc1">Accordion Title 01 <span></span></label>
			...
			<div class="accordion__item">
			  ...
			  <label class="accordion__label" for="acc2">Accordion Title 02 <span></span></label>
			  <div class="accordion__content">
				<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum</p>
			  </div>
			</div>
			<div class="accordion__item">
			  ...
			  <label class="accordion__label" for="acc3">Accordion Title 03 <span></span></label>
			  <div class="accordion__content">
				<p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum</p>
			  </div>
			</div>
